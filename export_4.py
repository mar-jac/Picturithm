...
boxes[0].applyalgo(Algo.shell)

background = Image.new('RGB', (vidwidth, vidheight))
ImageDraw.Draw(background).text((padding + (_lengthx - 280) // 2, padding + _lengthy), "Shell Sort (Knuth's formula)", (255, 255, 255), ImageFont.truetype("cour.ttf", 16))
