...
boxes[0].applyalgo(Algo.selection)

background = Image.new('RGB', (vidwidth, vidheight))
ImageDraw.Draw(background).text((padding + (_lengthx - 140) // 2, padding + _lengthy), "Selection Sort", (255, 255, 255), ImageFont.truetype("cour.ttf", 16))
