...
boxes[0].applyalgo(Algo.merge)

background = Image.new('RGB', (vidwidth, vidheight))
ImageDraw.Draw(background).text((padding + (_lengthx - 210) // 2, padding + _lengthy), "Merge Sort (in-place)", (255, 255, 255), ImageFont.truetype("cour.ttf", 16))
