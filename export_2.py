...
boxes[0].applyalgo(Algo.insertion)

background = Image.new('RGB', (vidwidth, vidheight))
ImageDraw.Draw(background).text((padding + (_lengthx - 110) // 2, padding + _lengthy), "Insertion Sort", (255, 255, 255), ImageFont.truetype("cour.ttf", 16))
